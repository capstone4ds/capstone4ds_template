...
![](images/BMI_Distribution_by_Diabetes_Status.png)
...
Limitations of the Diabetes Project

1. The stuidy is based on cross-sectional/observational NHANES data, which limits the ability to make causal inferences. Associations observed between BMI, age, diabetes status cannot confirm causation.
