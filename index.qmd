...
We transformed special codes (3,7,) to NA and included all NAs
    in the analysis. 
Visualization of missing data is presented below.
...
-   We conducted MICE to manage missiging data as an alternative to the Bayesian Approach @JSSv045i03
...
mice is performed on the imputed dataset. The model summary of the pooled imputed dataset presents odds ratio.
```{r}
#| label: Imputation 
#| echo: true
