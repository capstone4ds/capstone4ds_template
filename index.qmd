...
(2013–2014 NHANES survey). NHANES is a complex survey, and is not sampled uniformly: It uses stratification, clustering, and oversampling of certain groups in the population. We use Bayesian analytic approach to evaluates the
...
1.  Response Variable: Binary, **type 2 / diagnosed diabetes**
    (excluding gestational diabetes) -“Doctor told you have diabetes?” DIQ010
...
Merged dataset created, cleaned and visualized for any anamolies and to present results from Data Exploration (summary and tables presented below). 
...
# Plot overlay of observed vs predicted counts
...
# Alternative PP plots (histogram / barplot) for binary outcome
...
Plots from posterior disctribution 
- produces plots of the posterior distributions of all parameters in the model.
