...
-   Age and BM: strong positive associations with diabetes status,
...
ppc_bars() plot 
-  plot compared the observed and predicted diabetes outcomes
...
Autocorrelation plots are pairwise plots (mcmc_pairs, posterior) explore correlations between
parameters (age and BMI) coefficients 
-   assess chain mixing and convergence showing correlation
...
Interpretation of **Posterior correlation matrix among parameters** (e.g.,
