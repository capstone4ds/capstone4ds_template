...
prop_df <- tibble(
  ...
  proportion_Diabetes = prop_diabetes
)
...
```
- Histogram (predicted values of 100 draws) - the observed proportion of having Diabetes on 100 rows.
- To examine the probability of Diabetes with age groups -A scatterplot of the proportion of Diabetes grouped by age.
