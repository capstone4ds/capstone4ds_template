...
Pairwise correlations - A heatmap visualizing variables: diabetes_dx, age, and bmi show the
...
### Key Predictor Effects Predictor Effect Age (per 1 SD) 
- Log-odds of diabetes ↑1.09 per unit increase; strongest positive predictor BMI
    (per 1 SD) 
- Higher BMI increases diabetes risk (\~1.7–1.9× odds per
    SD)
...
### Posterior density plots illustrate parameter uncertainty 
- Posterior
