...
-   Prior is what we believed before seeing the data

-   We combine prior with what the data tells (likelihood) to obtain updated beliefs (the posterior).\

-   The prior has strong influence in a small sample size.\

-   As sample size increases, the influence of the prior goes to zero.\
    **After seeing the data**

-   the posterior distribution reflects the data, but also the regularizing pull of the prior\
...
rstan::monitor( samples = rstan::extract(fit, permuted = FALSE), probs = c(0.025, 0.5, 0.975) ) Provide summaries:
...
![](images/clipboard-2255770791.png)
:::
