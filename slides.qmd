...
Logistic link function transforms the linear predictor into a probability between (0 and 1)
...
- **df = 3 (degrees of freedom):** **heavy tails**- allow for occasional extreme values more than a normal distribution.\
...
- probability of very large or very small parameter values is very low and **stabilize the model**
...
-   PMM method for continuous (*Predictive Mean Matching)* - fills missing values with observed values that are “closest” to predicted values)
-   logistic regression for binary variables.
-   Provides multiple realistic versions of missing data
-   Using Rubin’s rules, the Estimates are pooled across posterior distributions to yield the correct full posterior\
...
![](images/clipboard-1727290712.png){width="740"}
