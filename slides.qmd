...
**diabetes_dx∼age_c + bmi_c + sex + race** Interpretation - model was estimated using svyglm(),**quasibinomial family** for binary outcome for NHANES design. - Design-adjusted coefficient estimates, standard errors, and odds ratios reflect population-representative associations for U.S. adults. - Age (per 1 SD ↑): OR ≈ 3.03 → Older adults \~3× higher odds - BMI (per 1 SD ↑): OR ≈ 1.88 → Higher BMI increases risk - Sex (Female vs Male): OR ≈ 0.53 → Females \~47% lower odds - Race (vs NH White): - Mexican American: OR ≈ 2.04 - Other Hispanic: OR ≈ 1.59 - NH Black: OR ≈ 1.67 - Other/Multi-racial: OR ≈ 2.33
...
### Interpretation (Trace Plots)

-   Convergence: well-mixed chains without trends indicate convergence and stable posterior estimates. Plots of posterior distributions with high uncertainty, narrow distributions indicating precise estimates.
...
### Interpretation (Autocorrelation)
...
| `Estimate        Est.Error       Q2.5        Q97.5 R2 0.1313342    0.01265055    0.1064607     0.156078` |
...
-   Median/mean predicted probability ≈ 0.25
-   The peak of the density curve is around 25%: participant has a 1 in 4 chance of being diabetic.
-   95% credible interval ≈ 0.20 to 0.31
-   The red dashed lines represent the 95% credible interval (CI): Lower bound ≈ 0.20 Upper bound ≈ 0.31

**Given the model and the participant’s characteristics, there is a 95% probability that this participant’s true diabetes risk lies between 20% and 31%**
:::
