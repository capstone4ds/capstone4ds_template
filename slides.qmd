...
**MAR: the reason for a data point being missing is related to other variables in the dataset, but not to the value of the missing variable itself**
...
-   Survey-weighted (Filtered = Adult): **5,769 (\~4%)**\
