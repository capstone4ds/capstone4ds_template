...
![](images/clipboard-2873800077.png){width="427"}![](images/clipboard-2016873286.png){width="596"}
...
rstan::monitor( samples = rstan::extract(fit, permuted = FALSE), probs = c(0.025, 0.5, 0.975) ) Provides the following summaries:
...
-   Subjectivity is present when - prior distribution influences the conclusions.
