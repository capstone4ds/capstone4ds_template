...
## MICE (Pooled Logistic Regression)
...
-   Implemented in `brms` (Stan backend), Posterior draws = 4000 (4 chains × 1000 iterations). Logistic link function![](images/clipboard-87871382.png){width="258" height="41"}
